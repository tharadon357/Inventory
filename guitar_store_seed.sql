...
SELECT * FROM (SELECT
    ...
    'https://images.unsplash.com/photo-1525201548942-d8732f6617a0?w=400' AS image, 'Active' AS status
) AS tmp
...
SELECT * FROM (SELECT
    ...
    'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=400' AS image, 'Active' AS status
) AS tmp
